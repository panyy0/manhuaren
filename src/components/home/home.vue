<template>
  <div class="home">
    ...
    <!--侧边栏-->
    <div v-if="somedata" id="doc-oc-demo1" @click.stop="hide" class="am-offcanvas am-active"
         style="touch-action: pan-y;user-select: none;-webkit-user-drag: none;-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
      <!--  .stop让事件停留在元素本身，阻止事件冒泡到父元素而执行父元素的事件-->
      <div @click.stop=""
           class="am-offcanvas-bar am-offcanvas-bar-flip am-offcanvas-bar-overlay am-offcanvas-bar-active">
